...
const en = {
  ...
  'toast': {
    ...
    'confirm': 'Confirm',
    'cancel': 'Cancel',
    'quit_room': 'Do you really want to exit the classroom ?',
    'kick': 'kicked',
    ...
    'teacher_exists': 'Teacher already exists, Please waiting for 30s or open a new class',
    ...
    'teacher_accept_whiteboard': 'Teacher has granted you whiteboard',
    'teacher_cancel_whiteboard': 'Teacher has canceled your whiteboard',
